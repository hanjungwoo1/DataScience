...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data', default="../data/OCR/result/train", help='path to training dataset')
    parser.add_argument('--valid_data', default="../data/OCR/result/valid", help='path to validation dataset')
